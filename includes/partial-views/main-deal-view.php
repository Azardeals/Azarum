        ...
        <div class="<?php echo $class; ?>">
            <aside class="col__left col-md-7 col-sm-7">
                <div class="item__gallery">
                    <div class="grid_left">
                        <ul class="item__main1">
                            <li><figure class="main__pic zoomImg"> <img rel="" src="<?php echo CONF_WEBROOT_URL . 'deal-image.php?id=' . $deal_id . '&mode=homeSliderMainImage&time=' . time(); ?>" alt="<?php echo appendPlainText($deal['deal_name' . $_SESSION['lang_fld_prefix']]); ?>" /></figure></li>
                            <?php
                            $thumbs = "";
                            while ($row = $db->fetch($image_rs)) {
                                echo '<li><figure class="main__pic zoomImg"><img rel="" src="' . CONF_WEBROOT_URL . 'deal-image.php?id=' . $row['dimg_id'] . '&mode=homeSliderImages&time=' . time() . '"  alt="' . appendPlainText($deal['deal_name']) . '"></figure></li>';
                                $thumbs .= '<li><figure class="item__thumb"><img  src="' . CONF_WEBROOT_URL . 'deal-image.php?id=' . $row['dimg_id'] . '&mode=thumbImages&time=' . time() . '"  alt="' . appendPlainText($deal['deal_name']) . '"></figure></li>';
                            }
                            ?>
                        </ul>
                    </div>
                    <?php if ($totalImages > 0) {
                        ...
                        <div class="grid_right">
                            <ul class=" item__thumbs item__thumbs1">
                                <li><figure class="item__thumb"> <img src="<?php echo CONF_WEBROOT_URL . 'deal-image.php?id=' . $deal_id . '&mode=mainthumbImages&time=' . time(); ?>" alt="<?php echo appendPlainText($deal['deal_name' . $_SESSION['lang_fld_prefix']]); ?>" /></figure></li>
                                <?php
                                echo $thumbs;
                                ?>
                            </ul>
            ...
            <aside class="col__right col-md-5 col-sm-5 siteForm">
                <span class="item__title"><?php echo appendPlainText($deal['deal_name' . $_SESSION['lang_fld_prefix']]); ?></span>
                <p><?php echo $deal['deal_subtitle']; ?></p>
                ...
                <div class="row__onehalf clearfix">
                        ...
                        <?php if (CONF_REVIEW_RATING_DEALS == 1) { ?>
                            <div class="ratingwrap">
                                ...
                                if ($reviewsRs->num_rows > 0) {
                                    ?>
                                    <a href="javascript:void(0);" onclick="showDealReviews();" class="txt__normal"><?php echo t_lang('M_TXT_REVIEWS'); ?> (<?php echo $reviewsRs->num_rows; ?>)</a>
                                <?php } ?>
                            </div>
                            <?php
                        }
                    ...
                    <div class="grid_2">
                        <div class="timer">
                            <span class="digit" id="spndaysleft1">00</span><?php echo t_lang('M_TXT_DAY'); ?>.
                            <span class="digit" id="spnhrsleft1">00</span><?php echo t_lang('M_TXT_HOURS'); ?>.
                            <span class="digit" id="spnmtsleft1">00</span><?php echo t_lang('M_TXT_MINUTES'); ?>.
                            <span class="digit" id="spnscsleft1">00</span><?php echo t_lang('M_TXT_SECONDS'); ?>.
                        </div>
                    </div>
                </div>
                <?php
                    ...
                    <li>
                        ...
                        <?php } else { ?>
                            ...
                            <?php if ($deal['deal_status'] >= 3) { ?>
                               ...
                               <?php } else if ($pagename == "preview-deal") {
                                   ?>
                                   onclick="$.facebox('<?php echo t_lang('M_MSG_THIS_IS_DEAL_PREVIEW'); ?>');"
                                   <?php
                               } else {
                           ...
                           <?php } ?>
                           <?php if ($pagename == "preview-deal") { ?>
                            <span class="likeDeal_5" style="float:right;"><span class="heart ">
                                    <a class="heart__link" onclick="$.facebox('<?php echo t_lang('M_MSG_THIS_IS_DEAL_PREVIEW'); ?>');" href="javascript:void(0);"></a>
                                    <span class="heart__txt"> <?php echo t_lang("M_TXT_ADD_TO_FAVOURITES"); ?></span>
                                </span></span>
                            <?php
                        } else {
                    ...
                    <li class="last">
                        ...
                        if ($deal['deal_status'] == 1 && ($deal['deal_type'] == 0) && ($deal['deal_sub_type'] == 0 && $deal['deal_is_subdeal'] == 0 )) {
                            if (isset($_SESSION['logged_user']['affiliate_id']) > 0) {
                                ...
                                <?php } elseif ($pagename == "preview-deal") { ?>
                                    <a href="javascript:void(0);" class="themebtn themebtn--large themebtn--grey" onclick="$.facebox('<?php echo t_lang('M_MSG_THIS_IS_DEAL_PREVIEW'); ?>');" title="<?php echo t_lang('M_TXT_GIVE_AS_A_GIFT'); ?>">  <?php require_once CONF_VIEW_PATH . 'gift-svg.php' ?><?php echo t_lang('M_TXT_GIVE_AS_A_GIFT'); ?>
                                    <?php } else {
                                        ?>
                                    ...
                                    <div class="panelinfo__top clearfix">
                                        ...
                                        <div class="grid_2">
                                            ...
                                            <ul class="list__socials">
                                                ...
                                                <li class="fb"><a <?php if ($pagename == "preview-deal") { ?>onclick="$.facebox('<?php echo t_lang('M_MSG_THIS_IS_DEAL_PREVIEW'); ?>');" <?php } else { ?> class='st_facebook_large' <?php } ?> displayText='Facebook' href="javascript:void(0)"><i class="icon ion-social-facebook"></i></a></li>
                                                <li><a <?php if ($pagename == "preview-deal") { ?>onclick="$.facebox('<?php echo t_lang('M_MSG_THIS_IS_DEAL_PREVIEW'); ?>');" <?php } else { ?> class='st_twitter_large' <?php } ?> displayText='Tweet' href="javascript:void(0)"><i class="icon ion-social-twitter"></i></a></li>
                                                <li><a <?php if ($pagename == "preview-deal") { ?>onclick="$.facebox('<?php echo t_lang('M_MSG_THIS_IS_DEAL_PREVIEW'); ?>');" <?php } else { ?> class='st_linkedin_large' <?php } ?>  displayText='LinkedIn' href="javascript:void(0)"><i class="icon ion-social-linkedin"></i></a></li>
                                                <li><a <?php if ($pagename == "preview-deal") { ?>onclick="$.facebox('<?php echo t_lang('M_MSG_THIS_IS_DEAL_PREVIEW'); ?>');" <?php } else { ?> class='st_pinterest_large' <?php } ?>  displayText='Pinterest' href="javascript:void(0)"><i class="icon ion-social-pinterest"></i></a></li>
                                                <li><a <?php if ($pagename == "preview-deal") { ?>onclick="$.facebox('<?php echo t_lang('M_MSG_THIS_IS_DEAL_PREVIEW'); ?>');" <?php } else { ?> class='st_email_large' <?php } ?>  displayText='Email' href="javascript:void(0)"><i class="icon ion-android-mail"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <script src="<?php echo CONF_WEBROOT_URL; ?>js/slick.js" type="text/javascript"></script>
                                ...
                                <script type="text/javascript">
                                                    ...
                                                    function updateSecsLeft() {
                                                        ...
                                                        if (remaining < 0) {
                                                            $('#timedisp').html('<li id="spnmtsleft1">EXPIRED</li>');
                                                            return;
                                                        }
                                                        days = Math.floor(remaining / (3600 * 24));
                                                        $('#spndaysleft1').html(days);
                                                        remaining = remaining % (3600 * 24);
                                                        hours = Math.floor(remaining / 3600);
                                                        $('#spnhrsleft1').html(hours);
                                                        remaining = remaining % 3600;
                                                        mins = Math.floor(remaining / 60);
                                                        $('#spnmtsleft1').html(mins);
                                                        remaining = remaining % 60;
                                                        secs = Math.floor(remaining);
                                                        $('#spnscsleft1').html(secs);
