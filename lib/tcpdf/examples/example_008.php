 ...
 * @since 2008-03-04
 */
echo $text = utf8_decode('ÎžÎ¬Î½Î¸Î· Î”Î®Î¼Î¿Ï…');
echo '<br/>';
echo html_entity_decode($text,ENT_COMPAT,"iso-8859-7");
echo '<br/>';
echo $utf8_text = mb_convert_encoding( "ÎžÎ¬Î½Î¸Î· Î”Î®Î¼Î¿Ï…", "utf-8", "HTML-ENTITIES" );
exit;
...
$utf8text = utf8_encode('ÎžÎ¬Î½Î¸Î· Î”Î®Î¼Î¿Ï…');
