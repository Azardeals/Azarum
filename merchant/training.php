...
$arr_bread = array('' => t_lang('M_TXT_TRAINING_VIDEO'));
?>
</div></td>
<td class="right-portion">
    ...
    <?php $trainingRow = $db->query("select * from tbl_training_video where tv_status=1  and tv_user=2 order by tv_display_order asc"); ?>
